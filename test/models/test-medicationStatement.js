...
xdescribe('models medicationStatement', function () {
    ...
    before('connectDatabase', shared.connectDatabase('fhirmedicationstatementmodel'));
...
xdescribe('models medicationStatement search by page', function () {
    ...
    before('connectDatabase', shared.connectDatabase('fhirmedicationstatementmodelpage'));
